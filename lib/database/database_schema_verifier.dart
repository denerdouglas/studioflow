...
abstract final class DatabaseSchemaVerifier {
  ...
  static Future<void> _fixMojibake(Transaction txn) async {
    final queries = [
      "UPDATE categorias_produtos SET nome = REPLACE(nome, 'CosmÃ©ticos', 'Cosméticos') WHERE nome LIKE '%CosmÃ©ticos%';",
      "UPDATE categorias_produtos SET nome = REPLACE(nome, 'AtenÃ§Ã£o', 'Atenção') WHERE nome LIKE '%AtenÃ§Ã£o%';",
    ];
