...
abstract final class MigrationV16 {
  static Future<void> executar(
    ...
    await _adicionarColuna(db, 'estoque', 'conteudo_por_unidade', 'REAL NOT NULL DEFAULT 1');
    await _adicionarColuna(db, 'estoque', 'unidade_conteudo', "TEXT NOT NULL DEFAULT ''");
    await _adicionarColuna(db, 'estoque', 'revisao_modelagem_estoque', 'INTEGER NOT NULL DEFAULT 0');
