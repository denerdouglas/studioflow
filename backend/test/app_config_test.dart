...
void main() {
  test('Endpoint /api/v1/public/app-config retorna 200 e json valido sem exigir autenticacao', () async {
    final config1 = BackendConfig(
      ...
      appStoreUrl: 'https://play.google.com/store/apps/details?id=com.rolgsystems.studioflow',
    ...
    final request = Request('GET', Uri.parse('http://localhost:8080/v1/public/app-config'));
    ...
    expect(android['store_url'], equals('https://play.google.com/store/apps/details?id=com.rolgsystems.studioflow'));
